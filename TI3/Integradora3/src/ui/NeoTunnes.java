...
public class NeoTunnes {
	...
	*/
	...
	public void registerPodcast(){
			...
			System.out.println("Enter the nickname of the creator to which the content belongs ");
			String nickname = sc.nextLine();
	
			System.out.println("Write a description of the content of your podcast");
	...
	private void reproducePlaylist() {
		{
			...
			Controller.createPlaylist(nickname, audioName);
